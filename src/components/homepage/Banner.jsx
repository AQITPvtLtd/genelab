  ...
  return (
    <div className="relative ">
      ...
      <div className="absolute inset-0 grid grid-cols-12 grid-rows-4">
        <div className="col-start-2 -ml-5 col-span-4 lg:text-lg text-sm lg:col-span-2 row-start-3 font-bold">
          <div className="hidden lg:flex text-lg">Call Now At</div>

          <Link
            href="tel:+91-981 172 4700"
            className="flex text-white border px-1 lg:px-10 bg-darkgreen hover:bg-darkgreen/90 rounded-lg py-2"
          >
