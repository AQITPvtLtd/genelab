...
const HomeBanner = () => {
  ...
  return (
    <div className="overflow-x-clip xl:mt-0 mt-[200px]">
      <div className="relative">
        ...
        <div className=" absolute inset-0 xl:mt-[240px] mt-[15px] xl:ml-0 ml-5">
          ...
          >
            ...
            {/* <div className="xl:grid grid-cols-8 xl:mt-10 mt-14 xl:mr-0 mr-7">
              <div
                className={`col-span-2 ml-3 shadow-2xl bg-white p-7 bg-opacity-50 rounded-full xl:mb-0 mb-3 ${
              ...
              <div
                className={`col-span-2 shadow-2xl col-start-4 bg-white p-5 bg-opacity-50 rounded-full xl:mb-0 mb-3 ${
              ...
              <div
                className={`col-span-2 mr-3 shadow-2xl col-start-7 bg-white p-7 lr-3 bg-opacity-50 rounded-full xl:mb-0 mb-3 ${
